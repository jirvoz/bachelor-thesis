...
Linear models try to separate classes with line, plane, hyperplane, etc.
...
\begin{figure}
  \centering
  \includegraphics[width=14cm]{tree_part}
...
carka pred and pokud delam vycet
poradi casti v kapitole o ai
