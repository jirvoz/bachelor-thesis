...
using \texttt{hours:minutes:seconds.milliseconds} format. The lower the run time
is, the better performance it represents.
...
\section{XML files} \label{sec:xml_files}
