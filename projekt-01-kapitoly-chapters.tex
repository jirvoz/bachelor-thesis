...
and their visualization for comparison is described in Chapter
\ref{ch:processing}.

A new way of visualization of long-term results comparison called
\emph{Timelines} we propose in Chapter \ref{ch:timelines}. In Chapter
