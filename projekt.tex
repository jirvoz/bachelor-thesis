...
\projectinfo{
  ...
  abstract.en={Performance of process scheduler in a kernel of an operating
    ...
    applications. With the arrival of new technologies (e.g. symmetric
    ...
    It describes ways of measurement of the process scheduler of the Linux
    kernel, ways of collecting information about its behavior, of storing the
    collected data, and of the data visualization. The goal of this work is
    desing and implementation of a new way of visualization of long-term
