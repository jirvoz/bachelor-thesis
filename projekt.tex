...
\projectinfo{
  ...
  title.cs={Výkonnostní testování linuxového kernelu},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Performance Testing of Linux Kernel}, % název práce v angličtině / thesis title in english
