...
\projectinfo{
  ...
  abstract.cs={Výkon plánovače procesů v jádře operačního systému značně
    ...
    nových technologií (např. symetrický multiprocesing) se kód plánovače vyvíjí
    ...
    Hlavím cílem práce je pak návrh a implementace nového způsobu vizualizace
  ...
  abstract.en={Performance of process scheduler in kernel of operating system
    significantly influences the throughput and latency of all applications
    running above it. Any performance drop can have critical consequences on the
    applications. With arrival of new technologies (e.g. symetric
    multiprocesing) the code of scheduler evolves and grows. This requires not
    only functional, but also performance regression testing. This paper maps
    methods of performance testing in Red Hat, Inc. company. It describes ways
    of measurement of process scheduler of Linux kernel, collecting information
    about its behavior, storing the collected data and their visualization. The
    goal of this work is desing and implementation of new way of visualization
    of long-term measurements and utilization of machine learning for automatic
    classification of performance degradation between two results.}, % abstrakt v anglickém jazyce / abstract in english
